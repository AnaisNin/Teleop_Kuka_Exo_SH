...
//Test SH
	...
	PCA_synergy::sigma1_range_dataCollection[0]=-0.022;//fully closed -0.078 [iros] ; -0.095: best fit; -0.08: touching fingers; -0.055: for contact cases
	PCA_synergy::sigma1_range_dataCollection[1]=0.085;//0.070 [iros] fully opened
